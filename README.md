...
a web application that allows users to explore the different movies and cast members under a film series.
it is bootstrapped by CRA and written in Typescript without any external libraries.
